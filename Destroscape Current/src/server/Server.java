...
public class Server {
	...
	//GTLVOTE
	//public static MainLoader vote = new MainLoader("http://destroscape.com/", "Destroscapec_vote", "Destroscapepassword", "Destroscapec_vote");
	//ENDOFGTLVOTE
...
try {
	...
	ex.printStackTrace();
		...
		System.out.println("Launching Destroscape, enjoy playing.");
