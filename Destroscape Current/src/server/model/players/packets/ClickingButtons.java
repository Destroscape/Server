...
c.sendMessage("You do not have a familiar currently spawned");
 ...
 c.sendMessage("You teleported to the nex, our strongest boss, GOOD LUCK!");
							 ...
							 if (c.teleAction == 45) {
					c.getPA().spellTeleport(2713, 9453, 0);
                                                                c.sendMessage("You teleport to the Metal dragons lair!");
																}
				...
				if (c.dialogueAction == 10) {
					...
					c.sendMessage("Fixed thanks to Luis");
 ...
 c.sendMessage("This boss wil come soon, we promise!");
																							 ...
																							 if (c.teleAction == 45) {
					c.getPA().spellTeleport(2976, 3239, 0);
                                                                c.sendMessage("You teleport to Red Dragons!");
																}
				if (c.dialogueAction == 106) {
					if(c.getItems().playerHasItem(c.diceID, 1)) {
						c.getItems().deleteItem(c.diceID, c.getItems().getItemSlot(c.diceID), 1);	
			...
			case 9192:
					...
					c.getPA().spellTeleport(2916, 3628, 0);
                                                                c.sendMessage("The brutal avatar of destruction, yours to defeat.");
																										 ...
																										 if (c.teleAction == 45) {
					c.getPA().spellTeleport(3038, 9580, 0);
                                                                c.sendMessage("You teleport to the Frost dragon cave!");
																}
				if (c.dialogueAction == 106) {
					if(c.getItems().playerHasItem(c.diceID, 1)) {
						c.getItems().deleteItem(c.diceID, c.getItems().getItemSlot(c.diceID), 1);	
...
if(c.teleAction == 235) {
c.getPA().movePlayer(2390, 9886, 0);
...
c.getPA().closeAllWindows();
c.sendMessage("<img=13>[Lawless] By the power of Destroscape, i have teleported you.<img=13>");
return;
}
if(c.teleAction == 1335) {
c.sendMessage("You have launched the website.");
c.getPA().closeAllWindows();
c.getPA().sendFrame126("http://destroscape.com/", 12000);
return;
}
...
break;
			...
			c.getPA().startTeleport(2956, 3210, 0, type);	
			break;
			...
			case 117131:
			case 4146:
			c.getDH().sendOption5("Godwars", "King Black Dragon (Wild)", "Dagannoth Kings", "Red Dragons", "Corporeal Beast");
			c.teleAction = 3;
			break;
...
/*
		...
		break;
		case 177212:
		c.getPA().spellTeleport(2956, 3210, 0);
		c.sendMessage ("Sorry this area has been close.");
		case 177221:
