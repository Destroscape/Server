...
public void addStarter() {
	...
	public void handleLoginText() {
		...
		c.getPA().sendFrame126("Monsters of Destroscape", 1301); //varrock description
		c.getPA().sendFrame126("Minigame Teleport", 1325); //lumbridge
		c.getPA().sendFrame126("Minigames of Destroscape", 1326); //lumbridge description
		c.getPA().sendFrame126("Boss Teleport", 1350); //falador
		c.getPA().sendFrame126("Bosses of Destroscape", 1351); //falador description
		c.getPA().sendFrame126("PKing Teleport", 1382); //camelot
		c.getPA().sendFrame126("PK Areas of Destroscape", 1383); //camelot description
		c.getPA().sendFrame126("Skill Teleport", 1415);	//ardougne
		c.getPA().sendFrame126("Skill Area of Destroscape", 1416); //ardougne description
		c.getPA().sendFrame126("City Teleports", 1454); //watchtower
		c.getPA().sendFrame126("Citys of Destroscape", 1455); //watchtower description
		c.getPA().sendFrame126("Advanced Skilling", 7457); //trollheim
		c.getPA().sendFrame126("Destroscape Advanced Skilling Area", 7458); //trollheim description
		c.getPA().sendFrame126("Advanced Bosses", 18472);	//ape atoll
		c.getPA().sendFrame126("Advanced Bosses of Destroscape", 18473); //ape atoll description

		//ancients
		c.getPA().sendFrame126("Monster Teleport", 13037); //varrock pad
		c.getPA().sendFrame126("Monsters of Destroscape", 13038); //varrock description
		c.getPA().sendFrame126("Minigame Teleport", 13047); //lumbridge senn
		c.getPA().sendFrame126("Minigames of Destroscape", 13048); //lumbridge description
		c.getPA().sendFrame126("Boss Teleport", 13055); //falador kharuyl
		c.getPA().sendFrame126("Bosses of Destroscape", 13056); //falador description
		c.getPA().sendFrame126("PKing Teleport", 13063); //camelot lassar
		c.getPA().sendFrame126("PK Areas of Destroscape", 1364); //camelot description
		c.getPA().sendFrame126("Skill Teleport", 13071);	//ardougne dareek
		c.getPA().sendFrame126("Skill Area of Destroscape", 13072); //ardougne description
		c.getPA().sendFrame126("City Teleports", 13081); //watchtower carrqalang
		c.getPA().sendFrame126("Citys of Destroscape", 13082); //watchtower description
		c.getPA().sendFrame126("Advanced Skilling", 13089); //trollheim annark
		c.getPA().sendFrame126("Destroscape Advanced Skilling Area", 13090); //trollheim description
		c.getPA().sendFrame126("Advanced Bosses", 13097);	//ape atoll ghorrock
		c.getPA().sendFrame126("Advanced Bosses of Destroscape", 13098); //ape atoll description
   	}
