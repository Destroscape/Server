...
public class StaticPacketBuilder implements PacketBuilder {
	...
	public StaticPacketBuilder() {
		this(StaticPacketBuilder.DEFAULT_SIZE);
	}
	 ...
	 */
	public StaticPacketBuilder(final int capacity) {
	 ...
	 */
	public StaticPacketBuilder addBits(int numBits, final int value) {
		...
		for (; numBits > bitOffset; bitOffset = 8) {
			payload[bytePos] &= ~StaticPacketBuilder.bitmasks[bitOffset]; // mask
			// out
			// the
			// desired
			// area
			payload[bytePos++] |= value >> numBits - bitOffset
					& StaticPacketBuilder.bitmasks[bitOffset];

			numBits -= bitOffset;
		}
		if (numBits == bitOffset) {
			payload[bytePos] &= ~StaticPacketBuilder.bitmasks[bitOffset];
			payload[bytePos] |= value & StaticPacketBuilder.bitmasks[bitOffset];
		} else {
			payload[bytePos] &= ~(StaticPacketBuilder.bitmasks[numBits] << bitOffset
					- numBits);
			payload[bytePos] |= (value & StaticPacketBuilder.bitmasks[numBits]) << bitOffset
					- numBits;
		}
		return this;
	}
	 ...
	 */
	public StaticPacketBuilder addByte(final byte val) {
	 ...
	 * @return A reference to this object
	 */
	private StaticPacketBuilder addByte(final byte val,
			final boolean checkCapacity) {
		if (checkCapacity) {
	...
	public StaticPacketBuilder addByteA(final int i) {
		return addByte((byte) (i + 128), true);
	}

	public StaticPacketBuilder addByteC(final int val) {
		addByte((byte) -val);
		return this;
	}
	 ...
	 * @return A reference to this object
	 */
	public StaticPacketBuilder addBytes(final byte[] data) {
	 ...
	 * @return A reference to this object
	 */
	public StaticPacketBuilder addBytes(final byte[] data, final int offset,
			final int len) {
		final int newLength = curLength + len;
	...
	public StaticPacketBuilder addByteS(final int val) {
	 ...
	 * @return A reference to this object
	 */
	public StaticPacketBuilder addInt(final int val) {
	...
	public StaticPacketBuilder addInt1(final int val) {
		ensureCapacity(curLength + 4);
		addByte((byte) (val >> 8), false);
		addByte((byte) val, false);
		addByte((byte) (val >> 24), false);
	...
	public StaticPacketBuilder addInt2(final int val) {
		ensureCapacity(curLength + 4);
		addByte((byte) (val >> 16), false);
		addByte((byte) (val >> 24), false);
		addByte((byte) val, false);
	...
	public StaticPacketBuilder addLEInt(final int val) {
		ensureCapacity(curLength + 4);
		addByte((byte) val, false);
		addByte((byte) (val >> 8), false);
		addByte((byte) (val >> 16), false);
	...
	public StaticPacketBuilder addLELong(final long val) {
		addLEInt((int) (val & -1L));
		addLEInt((int) (val >> 32));
		return this;
	}

	public StaticPacketBuilder addLEShort(final int val) {
	...
	public StaticPacketBuilder addLEShortA(final int i) {
		ensureCapacity(curLength + 2);
	 ...
	 * @return A reference to this object
	 */
	public StaticPacketBuilder addLong(final long val) {
		addInt((int) (val >> 32));
		addInt((int) (val & -1L));
		return this;
	}
	 ...
	 * @return A reference to this object
	 */
	public StaticPacketBuilder addShort(final int val) {
		ensureCapacity(curLength + 2);
		addByte((byte) (val >> 8), false);
		addByte((byte) val, false);
		return this;
	...
	public StaticPacketBuilder addShortA(final int i) {
		ensureCapacity(curLength + 2);
		addByte((byte) (i >> 8), false);
		addByte((byte) (i + 128), false);
		return this;
	...
	public StaticPacketBuilder addString(final String s) {
	...
	private void expandCapacity(final int minimumCapacity) {
		...
		final byte[] newPayload = new byte[newCapacity];
		try {
	 ...
	 */
	public StaticPacketBuilder setBare(final boolean bare) {
		this.bare = bare;
		return this;
	}
	 ...
	 */
	public StaticPacketBuilder setId(final int id) {
		this.id = id;
		return this;
	}

	public StaticPacketBuilder setShort(final int val, int offset) {
	...
	public StaticPacketBuilder setSize(final Packet.Size s) {
		size = s;
		return this;
	}
