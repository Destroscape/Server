...
public class RangeData {
	...
	public static int getRangeStr(int i) {
		...
		int[][] data = { { 877, 10 }, { 9140, 46 }, { 9145, 36 }, { 9141, 64 },
				...
				{ 9245, 120 }, { 9342, 90 }, { 882, 7 }, { 884, 10 }, { 886, 16 },
				{ 888, 22 }, { 890, 31 }, { 892, 49 }, { 4740, 55 }, { 3093, 1 },
	...
	public static int getRangeStartGFX(Player c) {
		...
		int[][] data = {
				...
				{ 4221, 250 }, { 4222, 250 }, { 4223, 250 }, {15241, 2138}, { 20171, 250 } };
		for (int l = 0; l < data.length; l++) {
	...
	public static int getRangeProjectileGFX(Player c) {
		...
		int[][] data = {
				...
				{ 4223, 249 }, {15243, 2142}, {11283, 1166},{ 20171, 249 }};
		for (int l = 0; l < data.length; l++) {
			if (c.rangeItemUsed == data[l][0]) {
				str = data[l][1];
			}
	...
	public static int getProjectileShowDelay(Player c) {
		int[] data = { 806, 806, 808, 809, 810, 811, 3093, 10033, 10034, 11230, };
		int str = 53;
