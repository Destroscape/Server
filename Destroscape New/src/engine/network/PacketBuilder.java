...
import engine.network.Packet.Type;
...
public class PacketBuilder {
	 ...
	 * @return The PacketBuilder instance, for chaining.
	 */
	public PacketBuilder put(final byte[] data, final int offset,
			final int length) {
	 ...
	 * @return The PacketBuilder instance, for chaining.
	 */
	public PacketBuilder putReverse(final byte[] is, final int offset,
			final int length) {
	 ...
	 * @return The PacketBuilder instance, for chaining.
	 */
	public PacketBuilder putReverseA(final byte[] is, final int offset,
			final int length) {
		for (int i = (offset + length - 1); i >= offset; i--)
			putByteA(is[i]);
		return this;
