...
public class SkillInterfaces {
	...
	public void miningComplex(int screen) {
		if (screen == 1) {
			...
			optionTab("Mining", "Ores", "Ores", "Pickaxes", "Skill Mastery",
					"", "", "", "", "", "", "", "", "", "");
		}
			...
			clearMenu();
			menuLine("99", "Skill Mastery", 9792, 0);
			optionTab("Mining", "Skill Mastery", "Ores", "Pickaxes",
					"Skill Mastery", "", "", "", "", "", "", "", "", "", "");
		}
	}
	...
	public void smithingComplex(int screen) {
		if (screen == 1) {
			...
			optionTab("Smithing", "Skill Mastery", "Smelting", "Bronze",
