...
public class DrawingArea extends NodeSub {
	...
	public static void drawPixelsWithOpacity(int color, int yPos,
			int pixelWidth, int pixelHeight, int opacityLevel, int xPos) {// method335
		if (xPos < topX) {
	...
	public static void drawHorizontalLine(int yPos, int lineColor,
			int lineWidth, int xPos) {// method339
	...
	public static void drawVerticalLine(int yPos, int lineColor,
			int lineHeight, int xPos) {// method341
	...
	public static void drawHorizontalLineWithOpacity(int lineColor,
			int lineWidth, int yPos, int opacityLevel, int xPos) {// method340
		if (yPos < topY || yPos >= bottomY)
			return;
		if (xPos < topX) {
			lineWidth -= topX - xPos;
	...
	public static void drawUnfilledPixels(int xPos, int pixelWidth,
			int pixelHeight, int color, int yPos) {// method337
