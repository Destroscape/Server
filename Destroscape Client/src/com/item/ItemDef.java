...
public class ItemDef {
	...
	public static void unpackConfig(StreamLoader streamLoader) {
		...
		if (Configuration.dumpItemModels) {
			ModelGrabber.dumpItems(totalItems);
		}

		System.out.println("667 Items Loaded: " + totalItems);

	}

	public static ItemDef forID(int i) {
		return CustomItems.forID(i);
	}
	
	protected void readValues(Stream stream)
	{
		do
		{
