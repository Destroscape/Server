...
public class RSApplet extends Applet implements Runnable, MouseListener,
		MouseMotionListener, KeyListener, FocusListener, MouseWheelListener,
		WindowListener {
	...
	public void handleInterfaceScrolling(MouseWheelEvent event) {
		...
		if (Client.openInterfaceID != -1 && Client.openInterfaceID != 34000
				&& Client.openInterfaceID != 33000) {
...
void mouseWheelDragged(int param1, int param2) {
	...
	public final void keyPressed(KeyEvent keyevent) {
		...
		if (hotKey == 508) {
			...
			if(Client.CameraPos1 > 6) {
				//Client.pushMessage2("You can't zoom out anymore.", 0, "");
			} else if(Client.CameraPos1 < 7) {
				Client.CameraPos1 += 1;
				Client.CameraPos2 += 200;
			}
			} else if (i == KeyEvent.VK_F12) {
			if(Client.CameraPos1 == 1) {
				//Client.pushMessage2("You can't zoom in anymore.", 0, "");
			} else if(Client.CameraPos1 > 1) {
				Client.CameraPos1 -= 1;
				Client.CameraPos2 -= 200;
			}
			}
