...
public class Model extends Animable {
	...
	public static void method460(byte abyte0[], int j) {
		...
		/*
		 * byte[] Byte0 = FileOperations.ReadFile(signlink.findcachedir() +
		 * "317Models/" + j + ".dat");
		 * FileOperations.WriteFile(signlink.findcachedir() + "Raw/" + j +
		 * ".dat",Byte0); System.out.println("Model ID: " + j + " Dumped");
		 */
				...
				if (i3 < anIntArrayArray1657.length) {
					...
					for (int j4 = 0; j4 < ai2.length; j4++) {
						...
						if (i7 != 0) {
							...
							int l8 = anIntArray1628[k5] * j7
									+ anIntArray1627[k5] * i8 >> 16;
						...
						if (k6 != 0) {
							...
							int i9 = anIntArray1628[k5] * j8
									- anIntArray1629[k5] * k7 >> 16;
							anIntArray1629[k5] = anIntArray1628[k5] * k7
									+ anIntArray1629[k5] * j8 >> 16;
							anIntArray1628[k5] = i9;
						}
						if (l6 != 0) {
							int l7 = modelIntArray1[l6];
							int k8 = modelIntArray2[l6];
							int j9 = anIntArray1629[k5] * l7
									+ anIntArray1627[k5] * k8 >> 16;
							anIntArray1629[k5] = anIntArray1629[k5] * k8
									- anIntArray1627[k5] * l7 >> 16;
	...
	public void method474(int i) {
		...
		for (int i1 = 0; i1 < anInt1626; i1++) {
			...
			anIntArray1629[i1] = anIntArray1628[i1] * k + anIntArray1629[i1]
					* l >> 16;
	...
	public final void method479(int i, int j, int k, int l, int i1, boolean flag) {
		...
		for (int i2 = 0; i2 < anInt1630; i2++) {
			if (anIntArray1640 != null && anIntArray1639 != null)
				if (anIntArray1640[i2] == 65535 || anIntArray1640[i2] == 0 // Black
																			// Triangles
																			// 633
																			// Models
