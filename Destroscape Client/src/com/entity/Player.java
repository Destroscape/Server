		...
		if (super.anInt1520 != -1 && super.anInt1521 != -1) {
			...
			if (model_2 != null) {
				Model model_3 = new Model(true,
						Class36.method532(super.anInt1521), false, model_2);
				model_3.method475(0, -super.anInt1524, 0);
				model_3.method469();
				model_3.method470(spotAnim.aAnimation_407.frames[super.anInt1521]);
	...
	public Model method452() {
		if (desc != null) {
			...
			if (super.anim >= 0 && super.anInt1529 == 0)
				j = Animation.anims[super.anim].frames[super.anInt1527];
			else if (super.anInt1517 >= 0)
				j = Animation.anims[super.anInt1517].frames[super.anInt1518];
		...
		if (super.anim >= 0 && super.anInt1529 == 0) {
			...
			k = Animation.anims[super.anInt1517].frames[super.anInt1518];
		...
		if (model_1 == null) {
			...
			for (int l2 = 0; l2 < 12; l2++) {
				...
				if (i3 >= 512) {
					Model model_4 = ItemDef.forID(i3 - 512)
							.method196(anInt1702);
					if (model_4 != null)
			...
			model_1.method469();
			model_1.method479(frontLight, backLight, rightLight, middleLight,
					leftLight, true);
